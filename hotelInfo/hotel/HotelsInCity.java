...
import com.xworkz.hotelInfo.constants.HotelType;

public class HotelsInCity {
	private HotelsDTO[] hotelDTO;
	private String services;
	private HotelType hotelType;
	private int currentIndex = 0;

	public HotelsInCity(int size) {
		hotelDTO = new HotelsDTO[size];
	}

	public void addHotel(HotelsDTO dto) {
	...
	public void displayByName(String name, Location location) {
		if (name != null && location != null) {
			...
			for (int i = 0; i < this.hotelDTO.length; i++) {
				HotelsDTO ref = this.hotelDTO[i];
				if (ref != null) {
					String localstart = ref.getName();
					com.xworkz.hotelInfo.constants.Location locallocation = ref.getLocation();
	...
	public void displayByName(String name, com.xworkz.hotelInfo.constants.Location mysore) {
